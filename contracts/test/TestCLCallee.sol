...
import "contracts/interfaces/ICLPool.sol";

contract TestCLCallee is IUniswapV3MintCallback, IUniswapV3SwapCallback, IUniswapV3FlashCallback {
    ...
    function mint(address pool, address recipient, int24 tickLower, int24 tickUpper, uint128 amount) external {
        ...
        ICLPool(pool).mint(address(this),recipient, tickLower, tickUpper, amount, abi.encode(msg.sender));
    }
