...
import {TestCLCallee} from "contracts/test/TestCLCallee.sol";
import {NFTManagerCallee} from "contracts/test/NFTManagerCallee.sol";
...
abstract contract BaseFixture is Test, Constants, Events, PoolUtils {
    ...
    function setUp() public virtual {
        ...
        nftCallee = new NFTManagerCallee(
            address(token0),
            address(token1),
            address(nft)
        );
    ...
    function deployDependencies() public virtual {
        ...
        votingRewardsFactory = IVotingRewardsFactory(
            new MockVotingRewardsFactory()
        );
    ...
    function addRewardToGauge(
        ...
        //TODO: Update notifyRewardAmount input
        // GaugeV2(_gauge).notifyRewardAmount(address(rewardToken), _amount);
        vm.stopPrank();
    }
    ...
    function labelContracts() internal virtual {
        ...
        vm.label({
            account: address(poolImplementation),
            newLabel: "Pool Implementation"
        });
