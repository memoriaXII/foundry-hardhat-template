...
abstract contract PoolUtils is Test, Constants, Events {
        ...
        returns (address _pool)
    {
        ...
        address implementation = CLPoolFactory(factory).poolImplementation();
    ...
    function createAndCheckPool(
        ...
        //TODO: Update createPool input
        //prev: tickSpacing, sqrtPriceX96
        CLPool pool = CLPool(factory.createPool(token0, token1, 100));
